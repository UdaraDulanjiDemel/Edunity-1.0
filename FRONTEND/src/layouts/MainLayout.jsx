            ...
            <div className="bg-white bg-opacity-30 backdrop-blur-lg rounded-xl shadow-md border border-white border-opacity-30 overflow-hidden">
              ...
              <div className="p-2">
                {suggestedUsers.map((user, index) => (
                  <motion.div
                    key={user.id}
                    className="group p-3 hover:bg-white hover:bg-opacity-40 rounded-lg transition-all duration-200"
                    initial={{ opacity: 0, x: 20 }}
                    animate={{
                      opacity: isLoaded ? 1 : 0,
                      x: isLoaded ? 0 : 20,
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <div className="relative">
                        <div className="h-12 w-12 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-white overflow-hidden ring-2 ring-white shadow-md">
                    ...
                    <div className="mt-3 flex space-x-2">
                      ...
                      <button 
                        ...
                        className="px-3 py-1.5 bg-white border border-gray-200 text-gray-600 text-sm rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
                      >
                        Ignore
                      </button>
                    </div>
                ...
                {suggestedUsers.length === 0 && (
                  <div className="p-6 text-center">
                    ...
                    <h4 className="text-gray-800 font-medium mb-1">No Suggestions</h4>
                    <p className="text-gray-600 text-sm">We'll show you people to connect with here</p>
                  </div>
                )}
              </div>
            </div>
